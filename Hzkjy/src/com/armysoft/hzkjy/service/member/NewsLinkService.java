 ...
 */
@Service
public class NewsLinkService extends BaseDao {

	private final String nameSpace = "NewsLinkOpt";
	 ...
	 * @param question
	 */
	public void insert(NewsLink model) {
	 ...
	 * @param question
	 */
	public void update(NewsLink model) {
