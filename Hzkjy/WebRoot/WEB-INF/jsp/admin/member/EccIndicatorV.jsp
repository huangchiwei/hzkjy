   ...
   <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr>
     ...
     <select name="hyfl"  id="hyfl" style="text-align:center">
          <option value="生物/医药技术业">生物/医药技术业</option>
          <option value="电子与信息业">电子与信息业</option>
          <option value="新材料技术/新材料业">新材料技术/新材料业</option>
          <option value="展览服务业">展览服务业</option>
          <option value="其他">其他</option>
          <option value="工业">工业</option>
          <option value="出园企业">出园企业</option>
        </select>
     </td>
