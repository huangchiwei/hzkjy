...
function importEmp(){  
	...
	$(document).ready(function(){
		var exl="${exl}";
		if(exl =="ok"){
		parent.location.href="${ctx}/member/memberBasic/list/1.html"
	    parent.layer.close();
		}
...
<div class="content_box">
  ...
  <div class="list_info">
  	<form id="search1_form" action="${ctx}/member/memberBasic/inputExport.html" method="post" enctype="multipart/form-data">
    <div class="div2">
