...
<form id="add_form" action='<c:if test="${model == null}">${ctx}/member/memberBasic/save.html</c:if><c:if test="${model != null}">${ctx}/member/memberBasic/update/${model.id}.html</c:if>' method="post">
