...
<link href="${ctx}/themes/admin/default/css/tab.css" rel="stylesheet" type="text/css" />
...
function switchSysBar(){
	...
	if (document.all("img1").src.indexOf("themes/admin/default/images/main_18.gif")>=0)
	{
	document.all("img1").src="${ctx}/themes/admin/default/images/main_18_1.gif";
	document.all("frmTitle").style.display="none";
	} 
	else
	{
	document.all("img1").src="${ctx}/themes/admin/default/images/main_18.gif";
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed;">
  <tr>
    ...
    <td width="7" valign="middle" onclick=switchSysBar()><span class="navPoint"><img src="${ctx}/themes/admin/default/images/main_18.gif" name="img1" width=7 height=81 id=img1></span></td>
   ...
   <div id="wrapper" >
     ...
     <div class="div_icon">
     <a href="#" onClick="refresh();"><img src="${ctx}/themes/admin/default/images/refresh.png"  alt="刷新当前页面" border="0"/></a>
     <a href="#" onClick="closeAllTab();openNew('welcome','${ctx}/admin/welcome.html');"><img src="${ctx}/themes/admin/default/images/close_all.png" alt="关闭所有页面" border="0"/></a>
     </div>
     </div>
